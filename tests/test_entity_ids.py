...
ERWARTETE_IDS = {
    ...
    "brenner_leistung_soll": "sensor.eta_heizung_brenner_leistung_soll",
    "brenner_temperatur": "sensor.eta_heizung_brenner_temperatur",
    "brenner_volllaststunden": "sensor.eta_heizung_brenner_volllaststunden",
    ...
    "heizkreis_raum": "sensor.eta_heizung_heizkreis_raumtemperatur",
    "heizkreis2_raum": "sensor.eta_heizung_heizkreis_2_raumtemperatur",
    "heizkreis3_raum": "sensor.eta_heizung_heizkreis_3_raumtemperatur",
    "heizkreis4_raum": "sensor.eta_heizung_heizkreis_4_raumtemperatur",
    "heizkreis_zeitprogramm": "sensor.eta_heizung_heizkreis_zeitprogramm",
    "heizkreis2_zeitprogramm": "sensor.eta_heizung_heizkreis_2_zeitprogramm",
    "heizkreis3_zeitprogramm": "sensor.eta_heizung_heizkreis_3_zeitprogramm",
    "heizkreis4_zeitprogramm": "sensor.eta_heizung_heizkreis_4_zeitprogramm",
    ...
    "komponente_brenner": "sensor.eta_heizung_komponente_brenner",
    "komponente_fernleitung": "sensor.eta_heizung_komponente_fernleitung",
    "komponente_puffer2": "sensor.eta_heizung_komponente_pufferspeicher_2",
    "komponente_puffer3": "sensor.eta_heizung_komponente_pufferspeicher_3",
    ...
    "puffer2_fuehler_1": "sensor.eta_heizung_puffer_2_fuhler_1",
    "puffer2_ladepumpe": "sensor.eta_heizung_puffer_2_ladepumpe",
    "puffer2_ladezustand": "sensor.eta_heizung_puffer_2_ladezustand",
    "puffer2_volumen": "sensor.eta_heizung_puffer_2_effektives_volumen",
    "puffer3_fuehler_1": "sensor.eta_heizung_puffer_3_fuhler_1",
    "puffer3_ladepumpe": "sensor.eta_heizung_puffer_3_ladepumpe",
    "puffer3_ladezustand": "sensor.eta_heizung_puffer_3_ladezustand",
    "puffer3_volumen": "sensor.eta_heizung_puffer_3_effektives_volumen",
    "puffer_energieinhalt": "sensor.eta_heizung_puffer_energieinhalt",
    "puffer_fuehler_1": "sensor.eta_heizung_puffer_fuhler_1",
    "puffer_ladepumpe": "sensor.eta_heizung_puffer_ladepumpe",
    "puffer_ladezustand": "sensor.eta_heizung_puffer_ladezustand",
    "puffer3_zustand": "sensor.eta_heizung_puffer_3_zustand",
    "puffer2_zustand": "sensor.eta_heizung_puffer_2_zustand",
    "puffer_zustand": "sensor.eta_heizung_puffer_zustand",
    "puffer_volumen": "sensor.eta_heizung_puffer_effektives_volumen",
